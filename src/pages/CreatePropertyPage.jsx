...
const CreatePropertyPage = () => {
  ...
  const onSubmit = (data) => {
    ...
    const propertyData = {
      name: data.name,
      type: data.type,
      organizationId: organizationId, // Add organizationId from auth context
      assignedManagers: userRole === 'property_manager' ? [userId] : [], // Auto-assign property manager who creates it
